...
class Readedid < Formula
    ...
    stable do
    url "https://github.com/othercat/readEDID", :using => :git, :tag => "20161106"
end
devel do
...
def install
    ...
    system "mkdir","/usr/local/Cellar/readedid/20161106/bin/"
    system "cp","bin/Debug/readedid","/usr/local/Cellar/readedid/20161106/bin/"
