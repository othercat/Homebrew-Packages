...
class Readedid < Formula
    ...
    stable do
    url "https://github.com/othercat/readEDID", :using => :git, :tag => "20161105"
end
devel do
...
def install
    ...
    system "mkdir","/usr/local/Cellar/readedid/20161105/bin/"
    system "cp","bin/Debug/readedid","/usr/local/Cellar/readedid/20161105/bin/"
