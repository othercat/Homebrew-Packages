...
class Readedid < Formula
    ...
    stable do
    url "https://github.com/othercat/readEDID", :using => :git, :tag => "1.0.3"
end
devel do
...
def install
    ...
    system "mkdir","/usr/local/Cellar/readedid/1.0.3/bin/"
    system "cp","bin/Debug/readedid","/usr/local/Cellar/readedid/1.0.3/bin/"
